...
pub fn update_oeuvre(conn: &Connection, oeuvre_id: i32, new_oeuvre: NewOeuvre) -> Result<usize> {
...
pub fn add_tag(conn: &Connection, oeuvre_id: i32, tag_label: String) -> Result<usize> {
...
pub fn update_rating(conn: &Connection, oeuvre_id: i32, rating: RatingOn100) -> Result<usize> {
